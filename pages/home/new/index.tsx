...
export default function NewMail() {
    ...
    icons['underline'] = `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    icons['blockquote'] = `<svg width="10" height="12" viewBox="0 0 10 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    icons['list'].ordered = `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    icons['list'].bullet = `<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M5 9.5H10" stroke="black" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M5 6H10" stroke="black" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M5 2.5H10" stroke="black" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div className={isExtend?'flex flex-col font-poppins bg-white p-18 h-full transition-all w-[calc(100vw-200px)] absolute bottom-0 right-0 border border-[#EFEFEF] rounded-10':'flex flex-col font-poppins bg-white p-18 h-502 w-[45vw] absolute bottom-0 right-0 border border-[#EFEFEF] rounded-10 transition-all'}>
        ...
        />*/}
        <EmailRecipientInput receivers={receivers} onAddReceiver={addReceiver} onRemoveReceiver={removeReceiver} />
        </h1>
        <BaseLine/>
        <h1 className='flex'>
                <div className='flex self-end ' >Subject</div>
                <input type="text" placeholder="" className="flex pl-6 mt-14 h-21 input w-full max-w-xs text-sm text-[#878787] focus:outline-none" 
                value={subject}
                onChange={(e) => {
                  e.preventDefault();
