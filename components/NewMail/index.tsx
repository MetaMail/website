...
export default function NewMail() {
    ...
    return (
        <div
            className={`dark:bg-[#2D2E2F] flex flex-col font-poppins bg-base-100 p-18 transition-all absolute bottom-0  rounded-22 ${
                isExtend ? 'h-full w-full right-0' : `h-502 w-[60vw] right-20 ${styles.newMailWrap}`
            } `}>
