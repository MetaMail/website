        ...
        <div className="">
                ...
                <li key={index} className={item.hidden === false ? 'auto' : 'hidden'}>
                  <button
                    ...
                    <div className="flex w-full justify-between">
                      ...
                      {item.title === 'Inbox' ? <span className="">{unreadCount === 0 ? '' : unreadCount}</span> : null}
                    </div>
                  </button>
                </li>
              );
                  ...
                  return (
                    <li key={index} className={item.hidden ? 'auto' : 'hidden'}>
                      <button
                        ...
                        <div className="">
                          <span className=""> {item.title}</span>
                          {item.title === 'Inbox' ? <span className="">{props?.unreadCount?.unread}</span> : null}
                        </div>
                      </button>
                    </li>
                  );
          ...
          <ul>
            <button
              ...
              <Icon url={showMore} className={dropTag ? 'mt-4 h-12 self-center rotate-90' : 'mt-4 h-12 self-center'} />
