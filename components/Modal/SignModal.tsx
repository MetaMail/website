  ...
  return (
    <div className='fixed w-[100vw]  h-[100vh] z-40' style={{ display: isShowSignature ? 'block' : 'none' }}>
      <div className="relative w-[100vw]  h-[100vh] flex justify-center items-center font-Poppins bg-transparent">
        <div style={{ background: `url(${ModalLogo.src}) center 40px no-repeat` }} className={`shadow-lg absolute flex flex-col justify-center items-center text-center pt-[97px]  box-border w-[440px] h-[240px] bg-white rounded-[15px]  z-[100] ${isShowSignature ? 'block' : 'hidden'}`}>
