...
function Review({ imgSrc, content, role, role2 }: IReview) {
  return (
    <div className="relative pb-20 md:pb-0 bg-white border border-[#1e1e1e] rounded-20 md:w-1/4 hover:scale-125 hover:z-20 transition-transform duration-500 font-poppins  shadow-md">
